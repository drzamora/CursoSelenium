...
public class TC003_Admin_AddNewUser {
	...
	public void TC003_Admin_AddNewUser_TC() {
		...
		// Espera implícita se usa para decirle al controlador web que espere una cierta
		// cantidad de tiempo.
		...
		// Inserta el texto "Admin", "admin123" y ejecuta la accion click en el bóton
		// login
		...
		// Inicializa y espera hasta las condiciones esperadas : tiempo de espera 30
		// segundos y/o sea visible el menu de la página
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@id='systemUser_password_strength_meter']")));
